...
//                    + "{\"text\":\"\\n \"}]";
    ...
    private String generateDynamicMessage(List<World> worlds) {
        StringBuilder jsonMessage = new StringBuilder("[\"\","
                ...
                + "{\"text\":\" Git\",\"bold\":true,\"color\":\"red\"},"
                + "{\"text\":\"Craft\",\"bold\":true,\"color\":\"gold\"},"
                + "{\"text\":\" \\u2550\\u2550\\n\\nBranch Join List\",\"bold\":true,\"color\":\"white\"},"
                + "{\"text\":\"\\n\\u2550\\u2550\\u2550\\u2550\\u2550\\u2550\\u2550\\u2550\\u2550\\u2550\\n\",\"bold\":true}");

        jsonMessage.append(",{\"text\":\"\\n\",\"bold\":true},"
                + "{\"text\":\"\\u2554\",\"color\":\"white\"},"
                + "{\"text\":\"[\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchjoin ").append(worlds.get(0).getName()).append("\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Click to join ").append(worlds.get(0).getName()).append("\"}},");
        jsonMessage.append("{\"text\":\"JOIN\",\"bold\":true,\"color\":\"green\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchjoin ").append(worlds.get(0).getName()).append("\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Click to join ").append(worlds.get(0).getName()).append("\"}},");
        jsonMessage.append("{\"text\":\"] ").append(worlds.get(0).getName()).append("\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchjoin ").append(worlds.get(0).getName()).append("\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Click to join ").append(worlds.get(0).getName()).append("\"}}");
        ...
        for (World world : worlds) {
            ...
            jsonMessage.append(",{\"text\":\"\\n\",\"bold\":true},"
                    + "{\"text\":\"\\u2560\",\"color\":\"white\"},"
                    + "{\"text\":\"[\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchjoin ").append(worldName).append("\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Click to join ").append(worldName).append("\"}},");
            jsonMessage.append("{\"text\":\"JOIN\",\"bold\":true,\"color\":\"green\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchjoin ").append(worldName).append("\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Click to join ").append(worldName).append("\"}},");
            jsonMessage.append("{\"text\":\"] ").append(worldName).append("\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchjoin ").append(worldName).append("\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Click to join ").append(worldName).append("\"}}");
        }
        if(!worlds.isEmpty()){
            jsonMessage.append(",{\"text\":\"\\n\",\"bold\":true},"
                    + "{\"text\":\"\\u255a\",\"color\":\"white\"},"
                    + "{\"text\":\"[\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchjoin ").append(lastWorld.getName()).append("\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Click to join ").append(lastWorld.getName()).append("\"}},");
            jsonMessage.append("{\"text\":\"JOIN\",\"bold\":true,\"color\":\"green\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchjoin ").append(lastWorld.getName()).append("\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Click to join ").append(lastWorld.getName()).append("\"}},");
            jsonMessage.append("{\"text\":\"] ").append(lastWorld.getName()).append("\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchjoin ").append(lastWorld.getName()).append("\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Click to join ").append(lastWorld.getName()).append("\"}}");
