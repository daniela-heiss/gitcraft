    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            String jsonMessage = "[\"\","
                    ...
                    + "{\"text\":\"[\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchcreate EXAMPLEBRANCH\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Create a new branch\"}},{\"text\":\"CREATE\",\"bold\":true,\"color\":\"aqua\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchcreate EXAMPLEBRANCH\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Create a new branch\"}},{\"text\":\"]\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranchcreate EXAMPLEBRANCH\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Create a new branch\"}},{\"text\":\"\\n\\u2560\"},"
