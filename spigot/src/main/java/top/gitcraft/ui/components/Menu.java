...
public class Menu {
    ...
    public String branchMenu(){
        ...
        return "[\"\","
                ...
                + "{\"text\":\"[\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranch create\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Create a new branch\"}},{\"text\":\"CREATE\",\"bold\":true,\"color\":\"aqua\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranch create\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Create a new branch\"}},{\"text\":\"]\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/gcbranch create\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":\"Create a new branch\"}},{\"text\":\"\\n\\u2560\"},"
